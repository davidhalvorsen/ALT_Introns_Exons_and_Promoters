...
ggplot2(telomerase_chromosome_lengths_play, names.arg=telomerase_chromosome_names, las=2, main ="TEL+ Telomere Lengths for Chromosomes", xlab="Chromosome", ylab="Telomere Lenghts (bp)")
;